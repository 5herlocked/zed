...
impl AmazonQCompletionProvider {
    pub fn new(amazon_q: Entity<AmazonQ>) -> Self {
        Self {
            amazon_q,
            buffer_id: None,
            file_extension: None,
...
impl EditPredictionProvider for AmazonQCompletionProvider {
    fn name() -> &'static str {
        "amazon_q"
    }
    ...
    fn is_enabled(&self, _buffer: &Entity<Buffer>, _cursor_position: Anchor, cx: &App) -> bool {
        self.amazon_q.read(cx).is_enabled()
    }
